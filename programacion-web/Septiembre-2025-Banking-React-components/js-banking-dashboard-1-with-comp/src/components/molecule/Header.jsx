        ...
        <div className='header__container'>
          <div className='header__brand'>
            <svg className='header__icon'>
              <use
                href='assets/icons/landmark.svg'
                width='100%'
                height='100%'
              ></use>
            </svg>
        ...
        <ul className='main__grid'>
          <li className='card'>
            <div className='card__header'>
              <div className='card__header-content'>
                <Button text='Inicio' icon='assets/icons/house.svg' disabled />
              </div>
            </div>
            <article className='card__content'>
              ...
              >
                <div className='content__description'>
                  ...
                  completo de todas tus cuentas bancarias, movimientos recientes
                  y estado financiero general.
                </div>
          ...
          <li className='card'>
            ...
            <article className='card__content'>
              ...
              >
                <div className='alert-list'>
                  <div className='alert-list__item'>
                    <svg className='icon icon--purple' alt='Heart icon'>
                      <use
          ...
          <li className='card'>
            ...
            <article className='card__content'>
              ...
              >
                <div className='content__description'>
                  Personaliza tu experiencia bancaria con opciones avanzadas de
                  configuración. Ajusta preferencias de notificaciones, límites
                  de transacciones y configuraciones de seguridad.
                </div>
                <div className='content__description content__description--margin-top'>
                  Incluye gestión de dispositivos autorizados, configuración de
                  autenticación de dos factores y personalización de la interfaz
                  según tus preferencias de uso.
                </div>
              </DisplayText>
            </article>
          </li>
